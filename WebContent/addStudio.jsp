...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-sm-9"><form class="form-horizontal" role="form" action="StudioServlet?method=add" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input type="text" class="form-control" id="studio_introduction" name="studio_introduction" 
                            placeholder="请输入影厅描述" required="required"  
                            oninput="setCustomValidity('')" >
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input type="text" class="form-control" id="studio_flag" name="studio_flag" 
                            placeholder="1：生成座位，0：不生成座位" pattern="^[01]$" 
